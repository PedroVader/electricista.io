...
const UI = {
  es: {
    ...
    home: { consejos: "Consejos", leerGuia: "Leer la guía", boletin: "Boletín eléctrico" },
  ...
  ca: {
    ...
    home: { consejos: "Consells", leerGuia: "Llegir la guia", boletin: "Butlletí elèctric" },
  ...
  en: {
    ...
    home: { consejos: "Guides", leerGuia: "Read the guide", boletin: "Electrical certificate" },
